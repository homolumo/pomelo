...
FrontendSession.prototype.bindAsync = async function(uid) {
  return bluebird.promisify(this.bind, {
    context: this
  })(uid);
};
...
FrontendSession.prototype.unbindAsync = async function(key) {
  return bluebird.promisify(this.unbind, {
    context: this
  })(key);
};
...
FrontendSession.prototype.pushAsync = async function(key) {
  return bluebird.promisify(this.push, {
    context: this
  })(key);
}
...
FrontendSession.prototype.pushAllAsync = async function(key) {
  return bluebird.promisify(this.pushAll, {
    context: this
  })();
}
