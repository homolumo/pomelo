...
ChannelService.prototype.pushMessageByRouteAsync = async function(route, msg, uids, opts) {
  return bluebird.promisify(this.pushMessageByUids, {
    context: this,
  })(route, msg, uids, opts);
};

ChannelService.prototype.pushMessageByUidAsync = async function(msg, uids, opts) {
  return bluebird.promisify(this.pushMessageByUids, {
    context: this,
  })(msg, uids, opts);
};
...
ChannelService.prototype.broadcastAsync = async function(stype, route, msg, opts) {
  return bluebird.promisify(this.broadcast, {
    context: this,
  })(stype, route, msg, opts);
}
...
Channel.prototype.pushMessageByRouteAsync = async function(route, msg, opts) {
  return bluebird.promisify(this.pushMessage, {
    context: this,
  })(route, msg, opts);
}

Channel.prototype.pushMessageAsync = async function(msg, opts) {
  return bluebird.promisify(this.pushMessage, {
    context: this,
  })(msg, opts);
}
